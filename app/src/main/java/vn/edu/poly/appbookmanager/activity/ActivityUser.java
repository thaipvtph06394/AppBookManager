...
public class ActivityUser extends AppCompatActivity {
      ...
      getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewTouchListener(getApplicationContext(), recyclerView, new RecyclerViewClickListener() {
            ...
            public void onLongClick(View view, final int position) {
                ...
                popup.getMenuInflater().inflate(R.menu.poupup_user, popup.getMenu());
    ...
    public void showDialogChangePassword() {
        ...
        doi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ActivityUser.this, "Đổi thành công", Toast.LENGTH_SHORT).show();
                dialog1.dismiss();
            }
        });
    }
   ...
   /* public void showDialogDoiMatKhau() {
    ...
    public void OnEdit(final User user) {
        ...
        edPhoneNumber.setText(user.sdt);
